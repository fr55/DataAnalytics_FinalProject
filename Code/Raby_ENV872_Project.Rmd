...
```{r echo = FALSE, eval = FALSE, fig.cap = "PM2.5 NC Monitoring Stations Previsualization. \\label{PM2.5Stations}"}
ggplot() + 
...
```{r fig.cap = "Counties exploratory map. \\label{Countyplot}"}
ggplot() +
...
```{r fig.cap = "Mean Annual Temperature exploratory map. \\label{Tempplot}"}
...
```{r fig.cap = "Combustion points for electricity generation in the North Carolina. \\label{Combplot}"}
